...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(reflector, userRepo, configService) {
    ...
    AuthGuard.prototype.canActivate = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var roles, gqlContext, decoded, user, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        gqlContext = graphql_1.GqlExecutionContext.create(context).getContext();
                        decoded = (0, jsonwebtoken_1.verify)(gqlContext[constants_1.ACCESS_TOKEN], this.configService.get('ACCESS_TOKEN_SECRET'));
